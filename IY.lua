...
CMDs[#CMDs + 1] = {NAME = 'executor', DESC = 'Opens Executor'}
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify("Outdated or False", "May get bc of executor or really outdated get new version at https://infyiff.github.io/ or https://infyiff.github.io/Download.html")
		end
